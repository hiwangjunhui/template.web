...
window.onscroll = function () {
	...
	if (theight > 755 && theight < 755 + document.getElementById("block_column").offsetHeight - document.getElementById("anchor_fixed").offsetHeight) {
		document.getElementById("anchor_fixed").className = "anchor_fixed";
		//document.getElementById("anchor_jbx").style.display = "block";
	}
	else {
		document.getElementById("anchor_fixed").className = "";
